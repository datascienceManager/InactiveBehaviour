# OTT Platform Churn Analysis - Complete Project

Comprehensive churn analysis and predictive modeling framework for OTT/streaming platforms using R (dplyr) and Python (python-pptx).
